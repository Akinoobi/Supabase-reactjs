  ...
  return (
    <>
      ...
      <div
        ...
        className={
          adjustment
            ? `max-w-[300px] sm:min-w-[350px] mt-8 sm:mt-0 sm:mb-12 centered overflow-y-auto sm:fixed max-h-[80%] ${
                contentClass || ""
              }`
            : `bg-white shadow-md ${isMobile ? "min-w-[95%]" : "min-w-[400px]"}  sm:min-w-[350] mt-8 sm:mt-0 sm:mb-12 centered sm:fixed max-h-[80%] ${
                contentClass || ""
              }`
        }
        style={!isOpen ? { opacity: 0, zIndex: -1 } : { zIndex: 5555 }}
      ...
      >
        {title || closable ? (
          ...
          >
            <div className={`${headerClass}`}>
              ...
              {subtitle ? (
                <div className="pr-12 text-xs text-gray-600">{subtitle}</div>
              ) : (
                ""
              )}
            </div>
        ...
        <div
          className={`${adjustment ? "" : "p-4"} overflow-y-auto ${
